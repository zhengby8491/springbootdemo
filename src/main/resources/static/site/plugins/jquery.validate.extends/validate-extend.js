...
(function()
{
	...
	}, "时间格式不正确，正确格式为：2019-01-01 12-00-00");
	...
	// 联系电话(手机/电话皆可)验证
	$.validator.addMethod("isContactNum", function(value, element)
	{
		var length = value.length;
	...
	{
		return this.optional(element) || /^[1-9a-zA-Z]\w{5,12}$/.test(value);
	...
	// 证件号码验证
	$.validator.addMethod("isIdCardAll", function(value, element)
	{
